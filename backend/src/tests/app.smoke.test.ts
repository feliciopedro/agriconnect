...
jest.mock('../prisma/client', () => ({
  ...
  default: {
    ...
    produceListing: { findUnique: jest.fn(), findMany: jest.fn(), create: jest.fn(), update: jest.fn(), count: jest.fn() },
    order: { findUnique: jest.fn(), findMany: jest.fn(), create: jest.fn(), count: jest.fn() },
    notification: { findMany: jest.fn(), create: jest.fn(), count: jest.fn(), update: jest.fn(), updateMany: jest.fn() },
    message: { create: jest.fn(), findMany: jest.fn(), count: jest.fn(), updateMany: jest.fn() },
    traceEvent: { findMany: jest.fn(), create: jest.fn() },
    traceabilityRecord: { findUnique: jest.fn() },
    deliveryRequest: { findMany: jest.fn(), findUnique: jest.fn(), create: jest.fn(), update: jest.fn() },
    review: { create: jest.fn(), findMany: jest.fn(), findFirst: jest.fn() },
